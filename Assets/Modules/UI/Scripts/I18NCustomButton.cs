...
{
    public class I18NCustomButton : MonoBehaviour
    {
        private string _key = "";
        ...
        private void _init()
        {
            _text = (TextMeshProUGUI)GetComponent<CustomButton>().textDisplay;
        ...
        private void _changeFont(I18NFonts f)
        {
            ...
            if (f != null)
            {
                ...
                {
                    _text.alignment = f.tmpro_alignment;
                }
            }
            else
            {
