...
namespace DLS.MainMenu
{
    public class SettingsMenuController : MonoBehaviour
    {
        ...
        [SerializeField] ValueWheel languageWheel;
        ...
        {
            string[] languages = I18N.instance.getLanguages();
            languageWheel.SetPossibleValues(languages, (int)I18N.instance.gameLang);
        }
        ...
        {
            // Language 
            LanguageCode language = (LanguageCode)Enum.GetValues(typeof(LanguageCode)).GetValue(languageWheel.activeValueIndex);
