...
public class Chip : MonoBehaviour {
	...
	// Value set by the save system, used to speed up saving process
	[HideInInspector]
	public int chipSaveIndex;
	//[HideInInspector]
	// Order of input/output signal chips.
	// This matters for them because it determines the order the pins will be in on the manufactured chip
	public int order;
	public int currentSequentialOuput;
	public int targetSequentialOutput;
	public float gateDelayRemaining;
